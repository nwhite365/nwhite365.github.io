  ...
  return (
    <div>
      ...
      <Element
        name="projects"
        style={{
          backgroundImage: `url(${coframeImage})`,
          backgroundRepeat: "no-repeat",
          backgroundPosition: "center",
          backgroundSize: "cover",
          height: "100%",
            ...
            <Stack sx={{ width: 3 / 4 }}>
              <Item>
                <BasicCard
                  header={"Projects"}
                  body={
                    "Below you can find a list of my ongoing and past projects."
                  }
                />
              </Item>
              <Item>
          ...
          >
            <Stack sx={{ width: 3 / 4 }}>
              <Item>
                <BasicCard
                  header={"Publications"}
                  body={"Below is a list of my recent publications"}
                />
              </Item>
              <Item>
                <ImageList
                ...
                >
                  {publicationJsons.map((publication) => {
                    return (
                      <ImageListItem key={publication.title}>
                        <PubCard {...publication} />
                      </ImageListItem>
                    );
                  })}
            ...
            <Stack sx={{ width: "50%" }}>
              <Item>
                <BasicCard
                  ...
                  body={
                    <Typography>
                      Below you'll find a copy of my CV. You can also download a
                      PDF copy{" "}
                      <a
